...
VALUES 
    ('Как лечить кашель?', 'Какие методы лучше использовать для лечения сухого кашля?', 1), 
    ('Что делать при температуре 38?', 'Какие лекарства лучше принимать при высокой температуре?', 2);
